...
class TestAPIConnector(unittest.TestCase):
    ...
    def test_093_api_extract_list_response(self, mock_get):
    ...
    @patch('requests.Session.get')
    def test_094_api_extract_dict_response(self, mock_get):
    ...
    def test_095_api_load_data(self, mock_post):
        """Test API load data"""
        mock_response = Mock()
        mock_response.status_code = 200
